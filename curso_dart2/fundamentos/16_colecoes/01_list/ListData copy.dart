  ...
  if (registros.length != 0) {
    if (registros.length < 4) {
      ...
      if (registros.length == 2 && registros.length % 2 == 0) {
        almoco = registros.last;
      } else if (registros.length == 3 && registros.length % 2 == 1) {
    ...
    if (registros.length >= 4 && registros.length % 2 == 1) {
      ...
      for (var i = 0; i < (registros.length / 2 - 1.5); i++) {
        if (i == 0) {
          pausa = registros[i + 3];
          ...
          print('${(i + 4) % 2 == 0 ? (i + 4 + 1) : (i + 4)}');
          pausa = registros[(i + 4) % 2 == 0 ? (i + 4 + 1) : (i + 4)];
          print('${(i + 5) % 2 == 1 ? (i + 5 + 1) : (i + 5)}');
          retorno = registros[(i + 5) % 2 == 1 ? (i + 5 + 1) : (i + 5)];
          print('PASSOU AQUI!');
