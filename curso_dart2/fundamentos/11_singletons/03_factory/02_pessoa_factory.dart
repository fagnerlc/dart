...
class PessoaInstancia {
  ...
  factory PessoaInstancia({String nome = 'indefinido', int? identidade}) {
    ...
    return _instancia ??= new PessoaInstancia._construtorNomeado(nome,
        identidade); // retorna a instancia, se ela for nula na primeira vez ele configura o construtor nomeado
  }
